...
//API setup
const API_KEY = "AIzaSyC0-Xvdts-8Ax8kuf2GFNp1ETYKD608Nfo";
...
const createMessageElement = (content, ...classes) => {
    ...
    div.classList.add("message", ...classes); //... means adding all classes to the div
...
const handleOutgoingMessage = (e) => {
    ...
    //storing the user's message by creating a global object, making it accessible throughout the project.
    messageInput.value = "";
